...
import { SaleStatus, InstallmentStatus } from '@/types';
import { getSaleStatusLabel, getSaleStatusColor, getInstallmentStatusLabel, getInstallmentStatusColor } from '@/lib/utils';
