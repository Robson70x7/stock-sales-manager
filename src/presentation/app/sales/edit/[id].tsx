...
export default function EditSaleScreen() {
  ...
  const [selectedClientId, setSelectedClientId] = useState<string | undefined>(sale?.clientId ?? undefined);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      let installments: import('@shared/types').Installment[] = sale.installments;
