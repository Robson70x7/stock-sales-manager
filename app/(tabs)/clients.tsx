  ...
  return (
    <ScreenContainer containerClassName="bg-background">
      <View style={[styles.header, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.count, { color: colors.muted }]}>{state.clients.length}</Text>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState
            ...
            subtitle={search ? 'Tente outro termo de busca' : 'Toque no botão + para adicionar seu primeiro cliente'}
          />
        }
        showsVerticalScrollIndicator={false}
      />

      <FAB onPress={() => router.push('/clients/new' as any)} />
    </ScreenContainer>
  );
}
